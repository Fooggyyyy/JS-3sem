document.addEventListener("DOMContentLoaded", () => {
    ...
    const generateFullBoardButton = document.getElementById("generateFullBoardButton");
    ...
    // Проверка, безопасно ли поставить число
    ...
    // Удаление ячеек для создания головоломки
    ...
    // Генерация правильно заполненного поля
    ...
    // Событие для генерации правильного поля
    generateFullBoardButton.addEventListener("click", () => {
        sudokuGrid = generateFullBoard();
        renderGrid();
        message.textContent = "";
    });
